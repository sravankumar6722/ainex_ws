...
class GetServoStatus_Response(metaclass=Metaclass_GetServoStatus_Response):
    ...
    def __init__(self, **kwargs):
        ...
        self.raw_positions = array.array('i', kwargs.get('raw_positions', []))
    ...
    def __eq__(self, other):
        ...
        if self.angles != other.angles:
            return False
        if self.raw_positions != other.raw_positions:
            return False
        ...
        if self._check_fields:
            if isinstance(value, array.array):
                assert value.typecode == 'i', \
                    "The 'raw_positions' array.array() must have the type code of 'i'"
                self._raw_positions = value
                return
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            ...
            assert \
                ...
                "The 'raw_positions' field must be a set or sequence and each value of type 'int' and each integer in [-2147483648, 2147483647]"
        self._raw_positions = array.array('i', value)
...
class GetServoStatus_Event(metaclass=Metaclass_GetServoStatus_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<ainex_interfaces/GetServoStatus_Request, 1>',
        'response': 'sequence<ainex_interfaces/GetServoStatus_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ainex_interfaces', 'srv'], 'GetServoStatus_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ainex_interfaces', 'srv'], 'GetServoStatus_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from ainex_interfaces.srv import GetServoStatus_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
    ...
    def response(self, value):
        if self._check_fields:
            from ainex_interfaces.srv import GetServoStatus_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_GetServoStatus(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ainex_interfaces.srv.GetServoStatus')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from ainex_interfaces.srv import _get_servo_status
...
class GetServoStatus(metaclass=Metaclass_GetServoStatus):
    from ainex_interfaces.srv._get_servo_status import GetServoStatus_Request as Request
    from ainex_interfaces.srv._get_servo_status import GetServoStatus_Response as Response
    from ainex_interfaces.srv._get_servo_status import GetServoStatus_Event as Event
