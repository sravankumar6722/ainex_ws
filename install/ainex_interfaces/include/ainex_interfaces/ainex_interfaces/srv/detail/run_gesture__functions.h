...
#ifndef AINEX_INTERFACES__SRV__DETAIL__RUN_GESTURE__FUNCTIONS_H_
#define AINEX_INTERFACES__SRV__DETAIL__RUN_GESTURE__FUNCTIONS_H_
...
/// Initialize srv/RunGesture message.
/**
 ...
 * )) before or use
 * ainex_interfaces__srv__RunGesture_Request__create()
...
/// Finalize srv/RunGesture message.
/**
...
/// Create srv/RunGesture message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ainex_interfaces__srv__RunGesture_Request__init().
...
/// Destroy srv/RunGesture message.
/**
 * It calls
 * ainex_interfaces__srv__RunGesture_Request__fini()
...
/// Check for srv/RunGesture message equality.
/**
...
/// Initialize array of srv/RunGesture messages.
/**
...
/// Finalize array of srv/RunGesture messages.
/**
 * It calls
 * ainex_interfaces__srv__RunGesture_Request__fini()
...
/// Create array of srv/RunGesture messages.
/**
 * It allocates the memory for the array and calls
 * ainex_interfaces__srv__RunGesture_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/RunGesture messages.
/**
 * It calls
 * ainex_interfaces__srv__RunGesture_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/RunGesture message array equality.
/**
...
/// Copy an array of srv/RunGesture messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * ainex_interfaces__srv__RunGesture_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_ainex_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ainex_interfaces__srv__RunGesture_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ainex_interfaces
...
/**
 * It calls
 * ainex_interfaces__srv__RunGesture_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ainex_interfaces
...
/**
 * It allocates the memory for the array and calls
 * ainex_interfaces__srv__RunGesture_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ainex_interfaces
...
/**
 * It calls
 * ainex_interfaces__srv__RunGesture_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * ainex_interfaces__srv__RunGesture_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_ainex_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ainex_interfaces__srv__RunGesture_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ainex_interfaces
...
/**
 * It calls
 * ainex_interfaces__srv__RunGesture_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ainex_interfaces
...
/**
 * It allocates the memory for the array and calls
 * ainex_interfaces__srv__RunGesture_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ainex_interfaces
...
/**
 * It calls
 * ainex_interfaces__srv__RunGesture_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // AINEX_INTERFACES__SRV__DETAIL__RUN_GESTURE__FUNCTIONS_H_
